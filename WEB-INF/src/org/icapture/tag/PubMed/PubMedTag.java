...
public class PubMedTag extends Tag {
	...
	public PubMedTag () {
		...
		tagFeatures.put("score", new TagFeature(0)); // added on 2007/07/13 to test removing frequency bias
	...
	public int getScore () {
		return tagFeatures.get("tagUnFreqBiasScore").fIntVal;
	}
	public void setScore (int f) {
		tagFeatures.put("tagUnFreqBiasScore", new TagFeature(f));
	}
}